...
router.post("/:accommodation/rooms", verifyAccessToken, user.IsAllowed(roles.ADMIN), upload.any(), roomValidation, RoomController.create);
router.put("/:accommodation/rooms/:id", verifyAccessToken, user.IsAllowed(roles.ADMIN), upload.any(), roomValidation, RoomController.update);
